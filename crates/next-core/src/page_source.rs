...
use crate::{
    ...
    next_server::context::{
        ...
        get_server_resolve_options_context, PageSsrType, ServerContextType,
    },
...
pub async fn create_page_source(
    ...
    let server_ty = Value::new(ServerContextType::Pages {
        pages_dir,
        ssr_type: PageSsrType::Ssr,
    });
    let server_data_ty = Value::new(ServerContextType::Pages {
        pages_dir,
        ssr_type: PageSsrType::Ssr,
    });
